...
class LearningControllerTest {
    ...
    void completeLesson_ReturnsAwardedXpAndLevel() throws Exception {
        when(completeLessonUseCase.execute(eq("learner@test.com"), eq("foundations_what_is_investing")))
    ...
    void getProgress_ReturnsCompletedLessonsAndTotals() throws Exception {
        when(getLearningProgressUseCase.execute(eq("learner@test.com")))
                .thenReturn(new LearningProgressResult(Set.of("foundations_what_is_investing"), Set.of(), 20, 1, 20, 50));
